...
const WHATSAPP_URL = "https://wa.me/553121158984/?text=Olá!+Gostaria+de+agendar+uma+visita+para+sala+Lygia+Clark.+A+sala+ainda+está+disponível?+:-D.";
      ...
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <AnimatedSection>
          ...
          <p className="text-lg text-surface-dark-foreground/60 mb-10">
            Agende uma visita e descubra como a Sala Lygia Clark pode transformar o seu negócio.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
        ...
        <div className="mt-16 pt-8 border-t border-surface-dark-foreground/10 text-sm text-surface-dark-foreground/40">
